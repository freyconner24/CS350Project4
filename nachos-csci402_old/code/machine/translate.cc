...
// from the virtual address
	...
	if (vpn >= pageTableSize) {
      ...
      for(int kk = 0; kk < pageTableSize; kk++){
        ...
        DEBUG('a', " Machine::Translate - PageTable virtual address: %d, physical address  %d!  isValid: %d\n, in processID: %d",
        pageTable[kk].virtualPage, pageTable[kk].physicalPage, pageTable[kk].valid, currentThread->space->processId);
