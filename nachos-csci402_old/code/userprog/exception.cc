...
void HandlePageFault(int virtualAddress) {
    ...
    tlb[tlbCounter % 4].virtualPage   = pageTable[virtualPage].virtualPage;
    tlb[tlbCounter % 4].physicalPage  = pageTable[virtualPage].physicalPage;
    tlb[tlbCounter % 4].valid         = pageTable[virtualPage].valid;
    tlb[tlbCounter % 4].use           = pageTable[virtualPage].use;
    tlb[tlbCounter % 4].dirty         = pageTable[virtualPage].dirty;
    tlb[tlbCounter % 4].readOnly      = pageTable[virtualPage].readOnly;
}
